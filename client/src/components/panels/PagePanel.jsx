          ...
          >
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                {currentPageIndex === i ? (
                  <span className="text-gray-300 text-[9px] font-medium">
                    Current page
                  </span>
                ) : (
            ...
            {/* Label */}
            <div
              className="px-1.5 py-1 rounded-b-xl"
      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            disabled={!canDelete}
            title={
              canDelete ? "Delete this page" : "Cannot delete the only page"
            }
