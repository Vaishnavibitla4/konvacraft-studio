  ...
  return (
    <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/50"
      ...
      <p className="text-sm text-gray-500 mb-6">
        {isSignUp ? 'Join thousands of designers today' : 'Sign in to continue designing'}
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {loading
            ...
            : isSignUp ? 'Create Account — Free' : 'Sign In'}
        </button>
      </form>
...
const MOCK_DESIGNS = [
  { bg: 'linear-gradient(135deg,#667eea,#764ba2)', label: 'Social Post', w: 180, h: 180 },
  { bg: 'linear-gradient(135deg,#f093fb,#f5576c)', label: 'Presentation', w: 220, h: 130 },
  { bg: 'linear-gradient(135deg,#4facfe,#00f2fe)', label: 'Banner', w: 200, h: 90 },
  { bg: 'linear-gradient(135deg,#43e97b,#38f9d7)', label: 'Poster', w: 150, h: 210 },
  { bg: 'linear-gradient(135deg,#fa709a,#fee140)', label: 'Thumbnail', w: 195, h: 110 },
  { bg: 'linear-gradient(135deg,#a18cd1,#fbc2eb)', label: 'Card', w: 170, h: 170 },
]

const FEATURES = [
  { icon: '🎨', title: 'Drag & Drop Canvas', desc: 'Pixel-perfect design with an intuitive Konva-powered canvas that feels buttery smooth.' },
  { icon: '🖼', title: 'Million+ Assets', desc: 'Search and use stunning photos & videos from Unsplash and Pexels directly in your design.' },
  { icon: '✨', title: '26+ Font Families', desc: 'From elegant serifs to playful scripts — beautiful typography at your fingertips.' },
  { icon: '📐', title: '10+ Shape Tools', desc: 'Rectangles, circles, stars, polygons, arrows and more with full property controls.' },
  { icon: '🎬', title: 'Video Elements', desc: 'Embed and control video clips directly on your canvas with playback, loop and volume.' },
  { icon: '⬇', title: 'Multi-format Export', desc: 'Export your masterpiece as PNG, JPG or WebM video in up to 3× resolution.' },
]

export default function LoginPage() {
  return (
    <div className="min-h-screen w-full overflow-x-hidden" style={{ background: '#0a0a0f', minHeight: '100vh' }}>
      <style>{`
        html, body, #root {
          min-height: 100%;
          overflow-y: auto;
      ...
      <section className="relative min-h-screen flex grid-bg overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 flex items-center px-8 py-5 z-20">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-lg">KonvaCraft Studio</span>
          </div>
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-16 px-8 py-24 pt-32 max-w-7xl mx-auto">
          ...
          {/* Left: Hero text */}
          <div className="flex-1 max-w-xl" style={{ animation: 'fadeInUp 0.8s ease both' }}>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-violet-950/60 border border-violet-700/50 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-violet-300 text-xs font-semibold">Free forever · No credit card needed</span>
            </div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              A professional design editor built on Konva. Create stunning graphics, social posts, presentations and more — with drag-and-drop simplicity.
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-10">
              {[
                ...
                <div key={i} className="pill-animate" style={{ animationDelay: `${0.1 * i + 0.4}s` }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/40 text-xs">Loved by 12,000+ designers</p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              KonvaCraft Studio packs the power of professional design software into a clean, fast browser-based editor.
            </p>
          </div>
      ...
      <section className="py-24 px-8 overflow-hidden" style={{ background: '#0a0a0f' }}>
        <div className="max-w-6xl mx-auto text-center mb-12">
          <p className="text-pink-400 text-sm font-semibold uppercase tracking-widest mb-3">Create anything</p>
      ...
      <section className="py-20 px-8 text-center relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, #1e0533, #0f0a1e, #1a0a2e)' }}>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <p className="text-white/60 text-lg mb-8">
            Join thousands of designers and start building beautiful graphics today. It's completely free.
          </p>
          <button
      ...
      {/* Footer */}
      <footer className="py-8 px-8 border-t border-white/10 text-center" style={{ background: '#0a0a0f' }}>
        <p className="text-white/30 text-sm">© 2025 KonvaCraft Studio · Built with ♥ and Konva.js</p>
      </footer>
    </div>
  )
}
